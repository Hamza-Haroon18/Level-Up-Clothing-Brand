...
import Add_data from './cosmeticsadd_data';
...
function Cosmetics() {
  ...
  const options = {
    category: ['Makeup', 'Haircare', 'Nailcare',],
    productType: [
      'Foundation',
      'Lipstick',
      'Mascara',
    ...
    brand: ['Maybelline', 'L’Oreal', 'MAC', 'Clinique', 'Dior', 'Revlon'],
    skinType: ['Oily', 'Dry', 'Combination', 'Sensitive', 'All Skin Types'],
    finish: ['Matte', 'Glossy', 'Natural', 'Dewy'],
    shade: ['Light', 'Medium', 'Dark', 'Universal'],
    size: ['10ml', '30ml', '50ml', '100ml', '200ml']
  };
