        ...
        {items ? (
          <>
            <div className="product-images">
              ...
              <button><Link to={`/admin/kid/kidedit-product/${id}`}>Edit Product</Link></button>
              <button><Link to={`/admin/kiddelete-product/${id}`}>Delete Product</Link></button>
            </div>
