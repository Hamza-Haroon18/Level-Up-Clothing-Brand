        ...
        {items ? (
          <>
            <div className="product-images">
              ...
              <button><Link to={`/admin/salewomen/saleedit-product/${id}`}>Edit Product</Link></button>
              <button><Link to={`/admin/saledelete-product/${id}`}>Delete Product</Link></button>
            </div>
