...
import Add_data from './salekidadd_data';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faCaretDown } from '@fortawesome/free-solid-svg-icons'
import './salekid.css';

function KidssaleUser() {
  ...
  const options = {
  category: ['Frock', 'Shirt & Shorts', 'Romper', 'Jumpsuit', 'Waistcoat Set', 'Kurta Pajama'],
