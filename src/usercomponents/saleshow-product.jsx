...
function ProductPagesaleUser() {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/admin/saleshow-product/${id}`)
      .then(res => res.json())
            ...
            <div className="product-info">
              ...
              {information && (
                <div className="details-grid">
                  ...
                  <div className="row"><span className="userlabel">Type:</span><span className="useruservalue">{items.productType}</span></div>
                </div>
              )}
            </div>
          </>
...
export default ProductPagesaleUser;
