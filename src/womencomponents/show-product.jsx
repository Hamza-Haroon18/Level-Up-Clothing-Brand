...
function ProductPage() {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/admin/show-product/${id}`)
      .then(res => res.json())
      .then(data => {
        ...
        {items ? (
          <>
            <div className="product-images">
              ...
              <button><Link to={`/admin/women/edit-product/${id}`}>Edit Product</Link></button>
              <button><Link to={`/admin/delete-product/${id}`}>Delete Product</Link></button>
            </div>
            ...
            <div className="product-info">
              ...
              <div className="detail-grid">
                ...
                <div className="row"><span className="labels"><a className="charts" href="/uploads/sizechart.webp" target="_blank">Size Chart</a></span><span className="values"></span></div>
              </div>
