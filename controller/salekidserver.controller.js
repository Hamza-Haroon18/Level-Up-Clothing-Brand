const Product = require("../models/salekidaddproduct.model.js");
const path = require("path");
const fs = require('fs');
// Add new product
const addProductkid = async (req, res) => {
    try {
        const {
            maincategory,
            productname,
...
// Get single product
const getshowproductkid = async (req, res) => {
    try {
...
// Update product
const updateProductkid = async (req, res) => {
    try {
        const id = req.params.id;
...
// Get all products
const getAllProductskid = async (req, res) => {
    try {
